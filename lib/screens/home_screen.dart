...
import 'package:redurx_light_starter/widgets/filtered_todos.dart';
  ...
  Widget build(BuildContext context) {
    return ConnectState<AppState>(
      ...
      builder: (state) => Scaffold(
            ...
            body: state.activeTab == AppTab.todos ? FilteredTodos() : Stats(),
            ...
            bottomNavigationBar: TabSelector(
              ...
              onTabSelected: (tab) => AppStore.dispatch(SetActiveTab(tab)),
            ),
          ),
    );
  }
